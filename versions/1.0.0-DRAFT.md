...
The `Lifecycle Task Info Object` describes a task to execute to move the product to a specific stage in its lifecycle. Each stage can contain multipe tasks.
